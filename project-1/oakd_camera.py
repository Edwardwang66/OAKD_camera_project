"""
OAKD Lite Camera Interface
Handles video capture from the OAKD Lite camera using DepthAI
Falls back to regular webcam if OAKD is not available
"""
import cv2
import numpy as np
...
class OAKDCamera:
    def __init__(self, use_oakd=True, fallback_camera_id=0):
        """
        Initialize the OAKD Lite camera
    ...
    def setup_pipeline(self):
        """Set up the DepthAI pipeline for RGB video capture"""
